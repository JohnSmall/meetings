class MeansOfInfluence < ApplicationRecord
  ...
  has_many :influence_government_office_people#,->{ influence_government_office_people},class_name: 'InfluenceGovernmentOfficePerson'
  has_many :influence_organisation_people#,->{ influence_organisation_people},class_name: 'InfluenceOrganisationPerson'
